 ...
 *
 * Usage:
 *   node tooling/_Debug_testing/playerServerCtl.mjs start [--port 3000]
 *   node tooling/_Debug_testing/playerServerCtl.mjs stop
 *   node tooling/_Debug_testing/playerServerCtl.mjs status
 *   node tooling/_Debug_testing/playerServerCtl.mjs restart
 *
 * State: tooling/_Debug_testing/.player-server.json
 * Logs:  tooling/_Debug_testing/player-server.log
 */
...
async function cmdStart(port) {
  ...
  console.log(`Stop with: node tooling/_Debug_testing/playerServerCtl.mjs stop`);
  process.exit(0);
}
