<#
    ...
    Usage:
        .\tooling\commands\Stop-Recovery.ps1           # ask it to stop, wait for it to wind down
        .\tooling\commands\Stop-Recovery.ps1 -Force    # also kill the processes if it lingers
#>
[CmdletBinding()]
param(
    [switch]$Force,
...
Write-Host ""
Write-Host "Resume with:  .\tooling\commands\Start-Recovery.ps1"
