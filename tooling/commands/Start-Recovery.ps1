<#
    ...
    Usage:
        .\tooling\commands\Start-Recovery.ps1              # run detached, survives closing this window
        .\tooling\commands\Start-Recovery.ps1 -Foreground  # run in this window, live output, Ctrl+C stops
#>
[CmdletBinding()]
param(
    [switch]$Foreground
...
if ($running.Count -gt 0) {
    ...
    Write-Host "To stop it:  .\tooling\commands\Stop-Recovery.ps1"
    return
}
...
Write-Host ""
Write-Host "Check progress:  .\tooling\commands\Status-Recovery.ps1"
Write-Host "Stop cleanly:    .\tooling\commands\Stop-Recovery.ps1"
