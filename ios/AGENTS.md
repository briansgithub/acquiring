...
- Ship to internal testers without asking. Building, archiving, uploading, entering build metadata, drafting and saving **What to Test** notes, and releasing to the internal group all proceed without confirmation — the request to build and release is the authorization. Fill in every required form field; do not stop partway to confirm intermediate steps. The two gates that remain are **external testers** (see below) and **Add for Review** / **Submit to App Review** for an App Store release.
