...
| F035 | Active melody, interval, chord, and chord-tone cards | Complete | Not started | P0 | XL | `MainActivity.kt`; `QuizIntervalState.kt` | Active-event/card state and visual surface remain. |
...
| F037 | Lock in Major relative-Ionian labels/rendering | Complete | Not started | P1 | L | `RelativeIonianContext.kt`; `MainActivity.kt` | The control is intentionally withheld until the relative-Ionian domain and renderer are real; no non-functional toggle is shipped. |
